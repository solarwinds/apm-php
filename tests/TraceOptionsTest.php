...
{
    public function testNoKeyNoValue()
    {
        $header = "=";
    ...
    public function testOrphanValue()
    {
        $header = "=value";
        $result = TraceOptions::from($header);
    ...
    public function testValidTriggerTrace()
    {
    ...
    public function testTriggerTraceNoValue()
    {
    ...
    public function testTriggerTraceDuplicate()
    {
    ...
    public function testTimestampNoValue()
    {
        $header = "ts";
        $result = TraceOptions::from($header);
    ...
    public function testTimestampDuplicate()
    {
    ...
    public function testTimestampFloat()
    {
        $header = "ts=12.34";
        $result = TraceOptions::from($header);
    ...
    public function testTimestampTrim()
    {
    ...
    public function testSwKeysNoValue()
    {
        $header = "sw-keys";
        $result = TraceOptions::from($header);
    ...
    public function testSwKeysDuplicate()
    {
    ...
    public function testSwKeysTrim()
    {
    ...
    public function testSwKeysIgnoreAfterSemi()
    {
    ...
    public function testCustomKeysTrim()
    {
    ...
    public function testCustomKeysNoValue()
    {
        $header = "custom-key";
        $result = TraceOptions::from($header);
    ...
    public function testCustomKeysDuplicate()
    {
    ...
    public function testCustomKeysEqualsInValue()
    {
    ...
    public function testCustomKeysSpacesInKey()
    {
    ...
    public function testOtherIgnored()
    {
        $header = "key=value";
        $result = TraceOptions::from($header);
    ...
    public function testTrimEverything()
    {
    ...
    public function testSemiEverywhere()
    {
    ...
    public function testMissingValuesAndSemi()
    {
